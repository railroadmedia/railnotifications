...
return [
    ...
    'entityManager'=>'Railroad\Railnotifications\Managers\RailnotificationsEntityManager',
    'requiredEntities' => [
        'Railroad\Railnotifications\Entities\User' => [
            'nr' => 1,
            'data' => [
                'email'=>'test@est.ro'
                ]
        ],
        'Railroad\Railnotifications\Entities\Notification' => [
            'nr' => 1,
            'data' => [
                'type'=>'comment reply',
                'data'=> [],
